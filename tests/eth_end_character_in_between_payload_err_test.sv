...
class eth_end_character_in_between_payload_err_test extends eth_base_test;
  ...
  error_cb err_cb;
  eth_end_char_in_payload_seq mac_0;
  eth_end_char_in_payload_seq mac_1;

  function new(string name = "eth_end_character_in_between_payload_err_test",
  ...
  task run_phase(uvm_phase phase);
    ...
    mac_0 = eth_end_char_in_payload_seq::type_id::create("mac_0");
    mac_1 = eth_end_char_in_payload_seq::type_id::create("mac_1");
