//******************************************************************//
//  ETHERNET CONSECUTIVE DIFFERENT-PRIORITY PFC XOFF/IMMEDIATE XON TEST
//
// Drives eth_pfc_multiple_stress_seq directly on mac_seqr_h[0], forked
// against plain traffic on mac_seqr_h[1]. No virtual_seq involved.
//******************************************************************//

`ifndef ETH_CONSEC_MULTIPLE_DIFF_PFC_XOFF_IMD_XON_TEST_SV
`define ETH_CONSEC_MULTIPLE_DIFF_PFC_XOFF_IMD_XON_TEST_SV 

class eth_consec_multiple_diff_pfc_xoff_imd_xon_test extends eth_base_test;

  `uvm_component_utils(eth_consec_multiple_diff_pfc_xoff_imd_xon_test)

  function new(string name = "eth_consec_multiple_diff_pfc_xoff_imd_xon_test",
  ...
  task run_phase(uvm_phase phase);
    eth_pfc_multiple_stress_seq mac_0;
    ...
    mac_0             = eth_pfc_multiple_stress_seq::type_id::create("mac_0");
    mac_0.cfg_h       = cfg_h[0];
