...
class eth_control_char_data_mismatch_test extends eth_base_test;
  ...
  error_cb err_cb;
  eth_control_char_data_mismatch_seq mac_0;
  eth_control_char_data_mismatch_seq mac_1;
  ...
  task run_phase(uvm_phase phase);
    foreach (env_h.agnt_mac[i]) begin
      env_h.agnt_mac[i].mon_h.set_report_severity_id_override(UVM_ERROR, "RS_UNKNOWN_CTRL",
                                                              UVM_WARNING);
    ...
    mac_0 = eth_control_char_data_mismatch_seq::type_id::create("mac_0");
    mac_1 = eth_control_char_data_mismatch_seq::type_id::create("mac_1");
