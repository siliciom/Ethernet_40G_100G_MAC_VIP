//******************************************************************//
//               ETHERNET PFC MULTIPLE PRIORITY XOFF TEST
//
// Drives eth_pfc_multi_priority_seq directly on mac_seqr_h[0], forked
// against plain traffic on mac_seqr_h[1]. No virtual_seq involved.
//******************************************************************//

`ifndef ETH_PFC_MULTIPLE_PRIORITY_XOFF_TEST_SV
`define ETH_PFC_MULTIPLE_PRIORITY_XOFF_TEST_SV 

class eth_pfc_multiple_priority_xoff_test extends eth_base_test;

  `uvm_component_utils(eth_pfc_multiple_priority_xoff_test)

  function new(string name = "eth_pfc_multiple_priority_xoff_test", uvm_component parent = null);
  ...
  task run_phase(uvm_phase phase);
    eth_pfc_multi_priority_seq mac_0;
    ...
    mac_0              = eth_pfc_multi_priority_seq::type_id::create("mac_0");
    mac_0.cfg_h        = cfg_h[0];
