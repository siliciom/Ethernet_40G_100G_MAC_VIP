...
class eth_preamble_corruption_test extends eth_base_test;
  ...
  error_cb err_cb;
  eth_preamble_corruption_seq mac_0;
  eth_preamble_corruption_seq mac_1;
  ...
  task run_phase(uvm_phase phase);
    ...
    mac_0 = eth_preamble_corruption_seq::type_id::create("mac_0");
    mac_1 = eth_preamble_corruption_seq::type_id::create("mac_1");
