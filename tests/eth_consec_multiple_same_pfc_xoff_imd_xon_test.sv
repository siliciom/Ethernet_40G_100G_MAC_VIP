//******************************************************************//
//    ETHERNET CONSECUTIVE SAME-PRIORITY PFC XOFF/IMMEDIATE XON TEST
//
// Drives eth_pfc_stress_seq directly on mac_seqr_h[0], forked against
// plain traffic on mac_seqr_h[1]. No virtual_seq involved.
//******************************************************************//

`ifndef ETH_CONSEC_MULTIPLE_SAME_PFC_XOFF_IMD_XON_TEST_SV
`define ETH_CONSEC_MULTIPLE_SAME_PFC_XOFF_IMD_XON_TEST_SV 

class eth_consec_multiple_same_pfc_xoff_imd_xon_test extends eth_base_test;

  `uvm_component_utils(eth_consec_multiple_same_pfc_xoff_imd_xon_test)

  function new(string name = "eth_consec_multiple_same_pfc_xoff_imd_xon_test",
  ...
  task run_phase(uvm_phase phase);
    ...
    // MAC0 RAL
    //
    // Keep both VLAN configurations enabled.
    // The transaction itself determines whether MAC0 transmits
    // PFC untagged or normal VLAN traffic.
    //=============================================================
    ...
    mac_0              = eth_pfc_stress_seq::type_id::create("mac_0");
